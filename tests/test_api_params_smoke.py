...
CASES = [
    ...
    pytest.param("/api/horarios/docente", {"docente_id": 1}, marks=pytest.mark.xfail(reason="endpoint con bug conocido en views_api (valores/campos)")),
    pytest.param("/api/horarios/profesorado", {"profesorado_id": 1}, marks=pytest.mark.xfail(reason="endpoint con bug conocido en views_api (valores/campos)")),
