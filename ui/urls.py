...
urlpatterns = [
    ...
    path(
        "api/horarios/materia/", views_api.api_get_horarios_materia, name="api_get_horarios_materia"
    ),
    path(
    ...
    # Administracion
    path(
        "administracion/comisiones/", views_panel.gestionar_comisiones, name="gestionar_comisiones"
    ),
    # Horarios
